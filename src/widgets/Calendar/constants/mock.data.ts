...
export const events = [
...

  {
    ...
    end: new Date(2022, 6, 14, 20, 30, 0)
  },
  {
    id: 25,
    title: "Накладывающееся событие",
    start: new Date(2022, 6, 14, 17, 0, 0),
    end: new Date(2022, 6, 14, 18, 30, 0)
  },
  {
    id: 26,
    title: "Собеседование по телефону",
  ...
  },
  {
    id: 28,
    title: "В спорзал",
    start: new Date(2022, 5, 14, 18, 30, 0),
    end: new Date(2022, 5, 14, 20, 0, 0)
  }
];
...
export const backgroundEvent = [
  {
    ...
    start: new Date(2022, 3, 13, 6),
    end: new Date(2022, 3, 13, 18)
  }
];
